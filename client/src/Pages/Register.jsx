    ...
    <div className="bg-[#1c1c21] w-screen h-screen flex justify-center items-center">
      <div className="w-full max-w-md bg-[#26262c] rounded-2xl shadow-lg p-10 flex flex-col items-center space-y-10">
        ...
        <h1 className="text-white text-3xl font-semibold text-center">
          Register to unlock <span className="text-blue-500 hover:text-blue-600">PlayTube</span>
        </h1>
        ...
        <div className="w-full flex flex-col items-center space-y-4">
          ...
          <Link to='/login' className="text-sm text-gray-400 hover:text-gray-200 cursor-pointer transition">Already have an Account?</Link>
        </div>
      </div>
    </div>
  );
